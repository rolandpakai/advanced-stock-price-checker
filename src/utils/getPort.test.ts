...
describe("getPort", () => {
  ...
  it("should return the port from environment variable when PORT is set as string number", () => {
    process.env.PORT = "9080";
    
    const port = getPort();
    
    expect(port).toBe(9080);
  });
  ...
  it("should return default port when PORT environment variable is not a valid number", () => {
  ...
  it("should return default port when PORT environment variable is zero", () => {
    process.env.PORT = "0";
  ...
  it("should return port when PORT environment variable is a valid positive number", () => {
    process.env.PORT = "9000";
